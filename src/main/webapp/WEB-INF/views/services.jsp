...
<body>
	...
	<div class="container">
		...
		<div class="text-center">
			<h3 class="text-success" style="color: #008000">${message} ${fn}
				${ln} ${em}</h3>
		...
		<div class="container">
			<form class="col-md-4" id="email-lookup" method="post"
				action="email-lookup">
					...
					<div class="container">
						...
						<div class="col-md-3">
							<div class="form-group">
								<label for="emailAddressInput">Email Look-Up*</label> <input
									type="hidden" name="roles" value="user" /> <input type="text"
									class="form-control" name="emailAddress" id="emailAddressInput"
									value="${attribs.emailAddress}" placeholder="Email Address"
									required />
							</div>
						</div>
      ...
      <div class="contact-form">
			...
			<form class="col-md-4" id="lookUpByLastnameOrFirstname" method="post"
				action="lookUpByLastnameOrFirstname">
				<div class="contact-form">
					<div class="container">
						<div class="col-md-3">
							<div class="form-group">
								<label for="ln" id='eln'>Name Look-up*</label> <input type=text
									id="lname" name="lname" value="${attribs.lname}"
									class="form-control input-sm" placeholder="Enter Name" required>
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
						...
						<c:forEach items="${users}" var="item">
							<tr class="text-success">
								...
								<th><c:out value="${item.address}" />, <c:out
										value="${item.city}" /> <c:out value="${item.state}" /> <c:out
										value="${item.zip}" /></th>
