      ...
      <div class="contact-form">
              <div class="container">
                    ...
                    <div class="col-md-3">
                     ...
                     <div class="col-md-3">
                           ...
                           <label for="subscription" id='subscription'>Subscription Type</label>
                              <select name="subscription" id="subscription" class="form-control input-sm">
                                  ...
                                  <option value="Annual Subscription" >Annual Subscription $100</option>  
                     ...
                     <%-- <div class="col-md-3">
                           <div class="form-group">
                              <label for="background" id='background' >back ground</label>                               
                              <input type='text' id="background" name="background" class="form-control input-sm" placeholder="enter background"  value="${attribs.background}"> 
                           </div>                           
                     </div> --%>
