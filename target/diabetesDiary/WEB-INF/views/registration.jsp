	...
	<div class="container">
		...
		<form:form method="POST" modelAttribute="registration"
					...
					<spring:bind path="zip">
						<div class="form-group ${status.error ? 'has-error' : ''}">
							...
							<form:input type="text" path="zip" class="form-control"
								placeholder="ZIP" autofocus="true"></form:input>
			...
			<div class="row">
				...
				<div class="col-md-3">
					<spring:bind path="emailAddress">
						<div class="form-group ${status.error ? 'has-error' : ''}">
							<label for="emailAddress" id='emailAddress'> Email
								Address*</label>
				...
				<div class="col-md-3">
					<spring:bind path="passwordConfirm">
						<div class="form-group ${status.error ? 'has-error' : ''}">
							<label for="passwordConfirm" id='passwordConfirm'>Confirm
								Password*</label>
			...
			<div class="row">
				<div class="col-md-6">
					<spring:bind path="background">
						<div class="form-group ${status.error ? 'has-error' : ''}">
							...
							<form:textarea type="text" path="background" rows="4"
								class="form-control" placeholder="Write  a short Biography* "></form:textarea>
				...
				<div class="col-md-3">
					<spring:bind path="subscription">
						<div class="form-group ${status.error ? 'has-error' : ''}">
							<label for="subscription" id='subscription'>
								*subscription</label>
							<form:select path="subscription" name="subscription"
								class="form-control input-sm">
								<option value="Life Time Membership">Life Time
									Membership $400</option>
								<option value="Anual Subscription">Annual Subscription
									$100</option>
								<option value="Monthly Subscription">Monthly
									Subscription $35</option>
								<option value="Free Trial">2 week Free trial</option>
								<option value="" selected>Select Subscription</option>

							</form:select>
							<form:errors class="text-danger" path="subscription"></form:errors>
						</div>
					</spring:bind>
				</div>
				<div class="col-md-4">
