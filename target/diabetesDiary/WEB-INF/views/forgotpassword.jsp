...
<form id="emails" method="post" action="forgotpass">			
		...
		<div class="container">									
			<div class="col-md-4">
				<div class="form-group">
					<input type="email" class="form-control"  value="${em}" id="emailAddress" name="emailAddress" placeholder="email Address" required>
		...
		<div class="container">
			<div class="col-lg-12">	
					...
					<a href="login" class="btn btn-primary" role="button">Cancel</a>
			</div>
		</div>		
	</div>
</form>	
